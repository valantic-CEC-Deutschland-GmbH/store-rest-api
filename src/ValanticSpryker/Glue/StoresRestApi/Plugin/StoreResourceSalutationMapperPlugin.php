 ...
 */
class StoreResourceSalutationMapperPlugin extends AbstractPlugin implements StoreResourceMapperPluginInterface
{
    /**
    ...
    public function map(StoresRestAttributesTransfer $storeRestAttributesTransfer): StoresRestAttributesTransfer
    {
        ...
        $storeRestAttributesTransfer->setSalutations($storeClient->getCurrentStore()->getAvailableSalutations());
